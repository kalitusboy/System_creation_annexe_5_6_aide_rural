...
/// <summary>
/// يُكافئ الدالة recomputeLogic() في HTML.
/// يحسب: المبلغ، النسب، النصوص بالحروف، الـ rubriques حسب نوع البناء.
/// </summary>
public static class LogicService
{
    public static AnnexeLogic Compute(AppSettings settings, AnnexeRequest request)
    {
        ...
        {
            logic.Rubrique1 = "ACHEVEMENT DES POTEAUX";
            logic.Rubrique2 = "ACHEVEMENT DE PLANCHER";
        }
        else
        {
            logic.Rubrique1 = "ACHEVEMENT DE PLATE-FORME";
            logic.Rubrique2 = "ACHEVEMENT DES POTEAUX";
        }
