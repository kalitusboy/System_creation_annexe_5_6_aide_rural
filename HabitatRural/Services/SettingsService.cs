...
namespace HabitatRural.Services {
    public class SettingsService {
        ...
        private static readonly JsonSerializerOptions _opts = new() { WriteIndented = true, Encoder = System.Text.Encodings.Web.JavaScriptEncoder.UnsafeRelaxedJsonEscaping };
        ...
        public void Replace(AppSettings s) { _current = s; Save(); }
    }
}